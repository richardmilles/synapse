...
export const projects: Project[] = [
  {
    slug: "plateforme-pilotage-client",
    name: "Plateforme de pilotage client",
    sector: "SaaS · Customer Success",
    type: "Application SaaS sur mesure",
    scope: ["Fiche client unifiée", "Score de santé", "Analyse IA", "Intégrations"],
    image: "/realisations/plateforme-pilotage-client.webp",
    imageWidth: 1400,
    imageHeight: 1050,
  ...
  {
    slug: "plateforme-restauration-entreprise",
    name: "Plateforme de restauration d’entreprise",
    ...
    image: "/realisations/plateforme-restauration-entreprise.webp",
    imageWidth: 1400,
    imageHeight: 1050,
  ...
  {
    slug: "plateforme-gestion-locative",
    name: "Plateforme de gestion locative",
    sector: "Proptech · Gestion locative",
    type: "Application métier multi-acteurs",
    scope: ["Portefeuille", "Incidents", "Prestataires", "Portail propriétaire", "Documents"],
    image: "/realisations/plateforme-gestion-locative.webp",
    imageWidth: 1400,
    imageHeight: 1050,
    ...
    outcome: "Le gestionnaire pilote son portefeuille, suit les opérations et coordonne toutes les parties prenantes depuis un système unique.",
  },
];
